...
class TestPartList:
    ...
    def test_get_part_using_name(self, part_list):
        # Safe cases
    ...
    def test_get_part_using_postion(self, part_list):
        # Safe cases
    ...
    def test_remove_part_using_name(self, part_list):
        # Safe cases
    ...
    def test_remove_part_using_postion(self, part_list):
        # Safe cases
